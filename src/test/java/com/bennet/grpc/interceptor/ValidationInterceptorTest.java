...
class ValidationInterceptorTest {
  ...
  void validator_shouldValidateDirectly() throws ValidationException {
    ...
    SayHelloRequest validRequest = SayHelloRequest.newBuilder().setName("World").build();
    ValidationResult result = validator.validate(validRequest);
    assertThat(result.isSuccess()).isTrue();

    SayHelloRequest invalidRequest = SayHelloRequest.newBuilder().setName("").build();
  ...
  void nameTooLong_shouldFailValidation() {
    ...
    SayHelloRequest request = SayHelloRequest.newBuilder().setName(longName).build();
  ...
  void nameAtMaxLength_shouldSucceed() {
    ...
    SayHelloRequest request = SayHelloRequest.newBuilder().setName(maxName).build();
